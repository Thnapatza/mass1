...
class JoinhangoutController extends Controller
{
    ...
    public function actionList(){
        ...
        foreach($model as $rs){
           ...
           // echo '<p>'.$rs->time.'<span class="pull-right">',Html::img('https://graph.facebook.com/'.$rs->fb_id.'/picture?type=large',['width'=>'10%']);'</span></p><p>'.$rs->time.'<span class="pull-right">'.$rs->user->username.'</span></p>';
        }
    } 
