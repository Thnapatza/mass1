...
<style type="text/css">
	...
	<a class="btn btn-info" href="http://localhost/sport/map/map">สถานที่แนะนำ</a>
                ...
                <?php // $form->field($model, 'massage_id')->dropDownList(
                        //ArrayHelper::map(Massagetype::find()->all() ,'id', 'name')
                    //) ?>
            ...
            <div class="col-md-6">
                ...
                <?php //$form->field($model, 'started_at')->widget(DateTimePicker::classname(), 
//                  [
//                         'name' => 'started_at',
...
//             ); ?>
                ...
                <?php // $form->field($model, 'finished_at')->widget(DateTimePicker::classname(), 
//                  [
//                         'name' => 'finished_at',
//                         'options' => ['placeholder' => 'Select operating time ...'],
//                         'convertFormat' => true,
...
//             ); ?>
             ...
             <?php // $form->field($model, 'sportcomplex')->textInput(['maxlength' => true]) ?>
            
               
            
                <?php // $form->field($model, 'createdby_id')->textInput() ?>
            
                <?php // $form->field($model, 'maxjoin')->textInput() ?>
